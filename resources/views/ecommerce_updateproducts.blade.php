...
<div class="tray tray-center">
    ...
    <div class="panel mb25 mt5">
        <div class="panel-heading">
            <span class="panel-title hidden-xs"> Update Product</span>
        </div>
                ...
                <div class="tab-content pn br-n admin-form">
                            ...
                            <div class="col-md-8 pl15">
                                <div class="section mb10">
                                    <label for="name2" class="field prepend-icon">
                                        <input type="text" name="ProdName" id="name2" class="event-name gui-input br-light light" placeholder="Product Name" value="{{ $product->ProdName }}" required>
                                ...
                                <div class="section mb10">
                                    ...
                                    <textarea style="height: 160px;" class="gui-textarea br-light bg-light" id="comment" name="ProdDescription" placeholder="Product Description" required>{{ $product->ProdDescription }}</textarea>
                    ...
                    <div class="section row">
                        ...
                        <label for="product-category" class="field select">
                          <select id="product-category" name="CategoryID" required disabled>
                              <option value="" disabled>Select Product Category</option>
                              <option value="1" {{ $product->CategoryID == 1 ? 'selected' : '' }}>Ring</option>
                              <option value="2" {{ $product->CategoryID == 2 ? 'selected' : '' }}>Necklace</option>
                              <option value="3" {{ $product->CategoryID == 3 ? 'selected' : '' }}>Bracelet</option>
                              <option value="4" {{ $product->CategoryID == 4 ? 'selected' : '' }}>Set</option>
                          </select>
                        ...
                        <div class="col-md-3">
                            <label for="product-sku" class="field prepend-icon">
                                <input type="string" name="ProdWeight" id="product-sku" class="gui-input" placeholder="Product Weight..." value="{{ $product->ProdWeight }}" required>
                        ...
                        <div class="col-md-3">
                            <label for="product-material" class="field prepend-icon">
                                <input type="text" name="ProdMaterial" id="product-material" class="gui-input" placeholder="Product Material..." value="{{ $product->ProdMaterial }}" required>
                        ...
                        <div class="col-md-3">
                          <label for="product-stock" class="field prepend-icon">
                              <div class="input-group">
                                  ...
                                  <input type="text" name="ProdStock" id="product-stock" class="form-control input-number text-center" placeholder="Quantity" value="{{ $product->Stock }}" required>
                                  <span class="input-group-btn">
                    ...
                    <div class="section row">
                        <div class="col-md-4">
                            <label for="product-price" class="field prepend-icon">
                                <input type="text" name="UnitPrice" id="product-price" class="gui-input" placeholder="Product Price..." pattern="[0-9]+(\.[0-9]+)?" title="Enter a valid number" value="{{ $product->UnitPrice }}" required>
                        ...
                        <div class="col-md-4">
                            <label for="product-size" class="field prepend-icon">
                                <input type="string" name="ProdSize" id="product-size" class="gui-input" placeholder="Product Size..." value="{{ $product->ProdSize }}" required>
                        ...
                        <div class="col-md-4">
                            <label for="product-discount" class="field prepend-icon">
                                <input type="text" name="ProdDiscount" id="product-discount" class="gui-input" placeholder="Product Discount..." pattern="[0-9]+(\.[0-9]+)?" value="{{ $product->ProdDiscount }}" title="Enter a valid number">

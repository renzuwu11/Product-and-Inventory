  ...
  <div id="main">
    ...
    <header class="navbar navbar-fixed-top">
      ...
      <ul class="nav navbar-nav navbar-left">
        <li>
          <a class="sidebar-menu-toggle" href="{{url('ecommerce_customers')}}#">
            <span class="ad ad-ruby fs18"></span>
          </a>
        </li>
        <li>
          <a class="topbar-menu-toggle" href="{{url('ecommerce_customers')}}#">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="{{url('ecommerce_customers')}}#">
          ...
          <ul class="dropdown-menu media-list w350 animated animated-shorter fadeIn" role="menu">
            ...
            <li class="media">
              <a class="media-left" href="{{url('ecommerce_customers')}}#"> <img src="assets/img/avatars/5.jpg" class="mw40" alt="avatar"> </a>
              <div class="media-body">
                <h5 class="media-heading">Article
                  <small class="text-muted">- 08/16/22</small>
                </h5> Last Updated 36 days ago by
                <a class="text-system" href="{{url('ecommerce_customers')}}#"> Max </a>
              </div>
            </li>
            <li class="media">
              <a class="media-left" href="{{url('ecommerce_customers')}}#"> <img src="assets/img/avatars/2.jpg" class="mw40" alt="avatar"> </a>
              <div class="media-body">
            ...
            <li class="media">
              <a class="media-left" href="{{url('ecommerce_customers')}}#"> <img src="assets/img/avatars/3.jpg" class="mw40" alt="avatar"> </a>
              <div class="media-body">
                <h5 class="media-heading">Article
                  <small class="text-muted">- 08/16/22</small>
                </h5> Last Updated 36 days ago by
            ...
            <li class="media">
              <a class="media-left" href="{{url('ecommerce_customers')}}#"> <img src="assets/img/avatars/4.jpg" class="mw40" alt="avatar"> </a>
              <div class="media-body">
                <h5 class="media-heading mv5">Article
                  <small class="text-muted">- 08/16/22</small>
                </h5> Last Updated 36 days ago by
        ...
        <li class="dropdown">
          <a href="{{url('ecommerce_customers')}}#" class="dropdown-toggle fw600 p15" data-toggle="dropdown"> <img src="assets/img/avatars/1.jpg" alt="avatar" class="mw30 br64 mr15"> John.Smith
          ...
          <ul class="dropdown-menu list-group dropdown-persist w250" role="menu">
            ...
            <li class="list-group-item">
              <a href="{{url('ecommerce_customers')}}#" class="animated animated-short fadeInUp">
    ...
    <aside id="sidebar_left" class="nano nano-primary affix">
      ...
      <div class="sidebar-left-content nano-content">
        ...
        <ul class="nav sidebar-menu">
          ...
          <li>
            <a class="accordion-toggle" href="{{url('ecommerce_customers')}}#">
          ...
          <li>
            <a class="accordion-toggle menu-open" href="{{url('ecommerce_customers')}}#">
          ...
          <li class="sidebar-proj">
            <a href="{{url('ecommerce_customers')}}#projectThree">
          ...
          <li class="sidebar-stat">
            <a href="{{url('ecommerce_customers')}}#projectOne" class="fs11">

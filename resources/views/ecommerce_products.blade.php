  ...
  <div id="main">
    ...
    <header class="navbar navbar-fixed-top">
      ...
      <ul class="nav navbar-nav navbar-left">
        <li>
          <a class="sidebar-menu-toggle" href="ecommerce_products#">
            <span class="ad ad-ruby fs18"></span>
          </a>
        </li>
        <li>
          <a class="topbar-menu-toggle" href="ecommerce_products#">
            <span class="ad ad-wand fs16"></span>
          </a>
        </li>
        <li class="hidden-xs">
          <a class="request-fullscreen toggle-active" href="ecommerce_products#">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="ecommerce_products#">
          ...
          <ul class="dropdown-menu media-list w350 animated animated-shorter fadeIn" role="menu">
            ...
            <li class="media">
              <a class="media-left" href="ecommerce_products#"> <img src="assets/img/avatars/5.jpg" class="mw40" alt="avatar"> </a>
              <div class="media-body">
                <h5 class="media-heading">Article
                  <small class="text-muted">- 08/16/22</small>
                </h5> Last Updated 36 days ago by
                <a class="text-system" href="ecommerce_products#"> Max </a>
              </div>
            </li>
            <li class="media">
              <a class="media-left" href="ecommerce_products#"> <img src="assets/img/avatars/2.jpg" class="mw40" alt="avatar"> </a>
              <div class="media-body">
            ...
            <li class="media">
              <a class="media-left" href="ecommerce_products#"> <img src="assets/img/avatars/3.jpg" class="mw40" alt="avatar"> </a>
              <div class="media-body">
                <h5 class="media-heading">Article
                  <small class="text-muted">- 08/16/22</small>
                </h5> Last Updated 36 days ago by
            ...
            <li class="media">
              <a class="media-left" href="ecommerce_products#"> <img src="assets/img/avatars/4.jpg" class="mw40" alt="avatar"> </a>
              <div class="media-body">
                <h5 class="media-heading mv5">Article
                  <small class="text-muted">- 08/16/22</small>
                </h5> Last Updated 36 days ago by
        ...
        <li class="dropdown">
          <a href="ecommerce_products#" class="dropdown-toggle fw600 p15" data-toggle="dropdown"> <img src="assets/img/avatars/1.jpg" alt="avatar" class="mw30 br64 mr15"> John.Smith
          ...
          <ul class="dropdown-menu list-group dropdown-persist w250" role="menu">
            ...
            <li class="list-group-item">
              <a href="ecommerce_products#" class="animated animated-short fadeInUp">
    ...
    <aside id="sidebar_left" class="nano nano-primary affix">
      ...
      <div class="sidebar-left-content nano-content">
        ...
        <ul class="nav sidebar-menu">
          ...
          <li>
            <a href="http://admindesigns.com/demos/admin/README/index">
          ...
          <li>
            <a class="accordion-toggle" href="ecommerce_products#">
            ...
            <ul class="nav sub-nav">
              <li>
                ...
                <ul class="nav sub-nav">
                  <li>
                    <a href="layout_sidebar-left-static">
                      Left Static </a>
                  </li>
                  <li>
                    <a href="layout_sidebar-left-fixed">
                      Left Fixed </a>
                  </li>
                  <li>
                    <a href="layout_sidebar-left-widgets">
                      Left Widgets </a>
                  </li>
                  <li>
                    <a href="layout_sidebar-left-minified">
                      Left Minified </a>
                  </li>
                  <li>
                    <a href="layout_sidebar-left-light">
                      Left White </a>
                  </li>
                  <li>
                    <a href="layout_sidebar-right-static">
                      Right Static </a>
                  </li>
                  <li>
                    <a href="layout_sidebar-right-fixed">
                      Right Fixed </a>
                  </li>
                  <li>
                    <a href="layout_sidebar-right-menu">
                      Right w/Menu </a>
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul class="nav sub-nav">
                  <li>
                    <a href="layout_navbar-static">
                      Navbar Static </a>
                  </li>
                  <li>
                    <a href="layout_navbar-fixed">
                      Navbar Fixed </a>
                  </li>
                  <li>
                    <a href="layout_navbar-menus">
                      Navbar Menus </a>
                  </li>
                  <li>
                    <a href="layout_navbar-contextual">
                      Contextual Example </a>
                  </li>
                  <li>
                    <a href="layout_navbar-search-alt">
                      Search Alt Style </a>
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul class="nav sub-nav">
                  <li>
                    <a href="layout_topbar">
                      Default Style </a>
                  </li> 
                  <li>
                    <a href="layout_topbar-menu">
                      Default w/Menu </a>
                  </li>  
                  <li>
                    <a href="layout_topbar-alt">
                      Alternate Style </a>
                  </li>  
                </ul>
              </li>
              <li>
                ...
                <ul class="nav sub-nav">
                  <li>
                    <a href="layout_content-blank">
                      Blank Starter </a>
                  </li>
                  <li>
                    <a href="layout_content-fixed">
                      Fixed Window </a>
                  </li>
                  <li>
                    <a href="layout_content-heading">
                      Content Heading </a>
                  </li>
                  <li>
                    <a href="layout_content-tabs">
                      Content Tabs </a>
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul class="nav sub-nav">
                  <li>
                    <a href="layout_tray-left">
                      Tray Left Static </a>
                  </li> 
                  <li>
                    <a href="layout_tray-left-fixed">
                      Tray Left Fixed </a>
                  </li> 
                  <li>
                    <a href="layout_tray-right">
                      Tray Right Static </a>
                  </li> 
                  <li>
                    <a href="layout_tray-right-fixed">
                      Tray Right Fixed </a>
                  </li> 
                  <li>
                    <a href="layout_tray-both">
                      Left + Right Static </a>
                  </li> 
                  <li>
                    <a href="layout_tray-both-fixed">
                      Left + Right Fixed </a>
                  </li> 
                </ul>
              </li>
              <li>
                ...
                <ul class="nav sub-nav">
                  ...
                  <li>
                    <a href="layout_boxed-horizontal">
                      Horizontal Menu </a>
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul class="nav sub-nav">
                  <li>
                    <a href="layout_horizontal-sm">
                      Small Size</a>
                  </li>
                  <li>
                    <a href="layout_horizontal-md">
                      Medium Size</a>
                  </li>
                  <li>
                    <a href="layout_horizontal-lg">
                      Large Size</a>
                  </li>
                  <li>
                    <a href="layout_horizontal-light">
                      Light Skin</a>
                  </li>
                  <li>
                    <a href="layout_horizontal-topbar">
                      With Topbar</a>
                  </li>
                  <li>
                    <a href="layout_horizontal-topbar-alt">
                      With Alt Topbar</a>
                  </li>
                  <li>
                    <a href="layout_horizontal-collapsed">
                      Collapsed onLoad</a>
                  </li>
                  <li>
                    <a href="layout_horizontal-boxed">
                      In Boxed Layout</a>
                  </li>
                </ul>
              </li>
          ...
          <li>
            <a class="accordion-toggle menu-open" href="ecommerce_products#">
          ...
          <li>
            ...
            <ul class="nav sub-nav">
              <li>
                ...
                <ul class="nav sub-nav">
                  <li>
                    <a href="maps_advanced">Admin Maps</a>
                  </li>
                  <li>
                    <a href="maps_basic">Basic Maps</a>
                  </li>
                  <li>
                    <a href="maps_vector">Vector Maps</a>
                  </li>
                  <li>
                    <a href="maps_full">Full Map</a>
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul class="nav sub-nav">
                  <li>
                    <a href="charts_highcharts">Highcharts</a>
                  </li>
                  <li>
                    <a href="charts_d3">D3 Charts</a>
                  </li>
                  <li>
              ...
              <li>
                ...
                <ul class="nav sub-nav">
                  <li>
                    <a href="tables_basic"> Basic Tables</a>
                  </li>
                  <li>
                    <a href="tables_datatables"> DataTables </a>
                  </li>
                  <li>
                    <a href="tables_datatables-editor"> Editable Tables </a>
                  </li>
                  <li>
                    <a href="tables_footable"> FooTables </a>
                  </li>
                  <li>
                    <a href="tables_pricing"> Pricing Tables </a>
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul class="nav sub-nav">
                  <li>
                    <a href="misc_tour"> Site Tour</a>
                  </li>
                  <li>
                    <a href="misc_timeout"> Session Timeout</a>
                  </li>
                  <li>
                    <a href="misc_nprogress"> Page Progress Loader </a>
                  </li>
                </ul>
              </li>
            </ul>
          ...
          <li>
            ...
            <ul class="nav sub-nav">
              <li>
                ...
                <ul class="nav sub-nav">
                  <li>
                    <a href="landing-page/landing1/index" target="_blank"> Landing Page </a>
                  </li>
                  <li>
                    <a href="pages_confirmation" target="_blank"> Confirmation
                      <span class="label label-xs bg-primary">New</span>
                    </a>
                  </li>
                  <li>
                    <a href="pages_login" target="_blank"> Login </a>
                  </li>
                  <li>
                    <a href="pages_login(alt)" target="_blank"> Login Alt
                      <span class="label label-xs bg-primary">New</span>
                    </a>
                  </li>
                  <li>
                    <a href="pages_register" target="_blank"> Register </a>
                  </li>
                  <li>
                    <a href="pages_register(alt)" target="_blank"> Register Alt
                      <span class="label label-xs bg-primary">New</span>
                    </a>
                  </li>
                  <li>
                    <a href="pages_screenlock" target="_blank"> Screenlock </a>
                  </li>
                  <li>
                    <a href="pages_screenlock(alt)" target="_blank"> Screenlock Alt
                      <span class="label label-xs bg-primary">New</span>
                    </a>
                  </li>
                  <li>
                    <a href="pages_forgotpw" target="_blank"> Forgot Password </a>
                  </li>
                  <li>
                    <a href="pages_forgotpw(alt)" target="_blank"> Forgot Password Alt
                      <span class="label label-xs bg-primary">New</span>
                    </a>
                  </li>
                  <li>
                    <a href="pages_coming-soon" target="_blank"> Coming Soon
                    </a>
                  </li>
                  <li>
                    <a href="pages_404"> 404 Error </a>
                  </li>
                  <li>
                    <a href="pages_500"> 500 Error </a>
                  </li>
                  <li>
                    <a href="pages_404(alt)"> 404 Error Alt </a>
                  </li>
                  <li>
                    <a href="pages_500(alt)"> 500 Error Alt </a>
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul class="nav sub-nav">
                  <li>
                    <a href="pages_search-results">Search Results
                      <span class="label label-xs bg-primary">New</span>
                    </a>
                  </li>
                  <li>
                    <a href="pages_profile"> Profile </a>
                  </li>
                  <li>
                    <a href="pages_timeline"> Timeline Split </a>
                  </li>
                  <li>
                    <a href="pages_timeline-single"> Timeline Single </a>
                  </li>
                  <li>
                    <a href="pages_faq"> FAQ Page </a>
                  </li>
                  <li>
                    <a href="pages_calendar"> Calendar </a>
                  </li>
                  <li>
                    <a href="pages_messages"> Messages </a>
                  </li>
                  <li>
                    <a href="pages_messages(alt)"> Messages Alt </a>
                  </li>
                  <li>
                    <a href="pages_gallery"> Gallery </a>
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul class="nav sub-nav">
                  <li>
                    <a href="pages_invoice"> Printable Invoice </a>
                  </li>
                  <li>
                    <a href="pages_blank"> Blank </a>
                  </li>
                </ul>
              </li>
            </ul>
          ...
          <li class="sidebar-proj">
            <a href="ecommerce_products#projectThree">
          ...
          <li class="sidebar-stat">
            <a href="ecommerce_products#projectOne" class="fs11">

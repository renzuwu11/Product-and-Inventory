    ...
    <div class="panel">
      ...
      <div class="panel-body pn">
        <ul class="nav nav-list nav-list-sm pl15 pt10" role="tablist">
          <li class="active">
            <a href="dashboard.blade.php#toolbox-header" role="tab" data-toggle="tab">Navbar</a>
          </li>
          <li>
            <a href="dashboard.blade.php#toolbox-sidebar" role="tab" data-toggle="tab">Sidebar</a>
          </li>
          <li>
            <a href="dashboard.blade.php#toolbox-settings" role="tab" data-toggle="tab">Misc</a>
          </li>
        </ul>
        ...
        <div class="form-group mn br-t p15">
          <a href="dashboard.blade.php#" id="clearLocalStorage" class="btn btn-primary btn-block pb10 pt10">Clear LocalStorage</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div id="main">
    ...
    <header class="navbar navbar-fixed-top">
      ...
      <ul class="nav navbar-nav navbar-left">
        <li>
          <a class="sidebar-menu-toggle" href="dashboard.blade.php#">
            <span class="ad ad-ruby fs18"></span>
          </a>
        </li>
        <li>
          <a class="topbar-menu-toggle" href="dashboard.blade.php#">
            <span class="ad ad-wand fs16"></span>
          </a>
        </li>
        <li class="hidden-xs">
          <a class="request-fullscreen toggle-active" href="dashboard.blade.php#">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="dashboard.blade.php#">
          ...
          <ul class="dropdown-menu media-list w350 animated animated-shorter fadeIn" role="menu">
            ...
            <li class="media">
              <a class="media-left" href="dashboard.blade.php#"> <img src="assets/img/avatars/5.jpg" class="mw40" alt="avatar"> </a>
              <div class="media-body">
                <h5 class="media-heading">Article
                  <small class="text-muted">- 08/16/22</small>
                </h5> Last Updated 36 days ago by
                <a class="text-system" href="dashboard.blade.php#"> Max </a>
              </div>
            </li>
            <li class="media">
              <a class="media-left" href="dashboard.blade.php#"> <img src="assets/img/avatars/2.jpg" class="mw40" alt="avatar"> </a>
              <div class="media-body">
            ...
            <li class="media">
              <a class="media-left" href="dashboard.blade.php#"> <img src="assets/img/avatars/3.jpg" class="mw40" alt="avatar"> </a>
              <div class="media-body">
                <h5 class="media-heading">Article
                  <small class="text-muted">- 08/16/22</small>
                </h5> Last Updated 36 days ago by
            ...
            <li class="media">
              <a class="media-left" href="dashboard.blade.php#"> <img src="assets/img/avatars/4.jpg" class="mw40" alt="avatar"> </a>
              <div class="media-body">
                <h5 class="media-heading mv5">Article
                  <small class="text-muted">- 08/16/22</small>
                </h5> Last Updated 36 days ago by
        ...
        <li class="dropdown">
          <a href="dashboard.blade.php#" class="dropdown-toggle fw600 p15" data-toggle="dropdown"> <img src="assets/img/avatars/1.jpg" alt="avatar" class="mw30 br64 mr15"> John.Smith
          ...
          <ul class="dropdown-menu list-group dropdown-persist w250" role="menu">
            ...
            <li class="list-group-item">
              <a href="dashboard.blade.php#" class="animated animated-short fadeInUp">
            ...
            <li class="dropdown-footer">
              <a href="dashboard.blade.php#" class="">
    ...
    <aside id="sidebar_left" class="nano nano-primary affix">
      ...
      <div class="sidebar-left-content nano-content">
        ...
        <header class="sidebar-header">
          ...
          <div class="sidebar-widget menu-widget">
            <div class="row text-center mbn">
              <div class="col-xs-4">
                <a href="dashboard.blade.php" class="text-primary" data-toggle="tooltip" data-placement="top" title="Dashboard">
          ...
          <div class="sidebar-widget author-widget hidden">
            <div class="media">
              <a class="media-left" href="dashboard.blade.php#">
                <img src="assets/img/avatars/3.jpg" class="img-responsive">
              </a>
              <div class="media-body">
                <div class="media-links">
                   <a href="dashboard.blade.php#" class="sidebar-menu-toggle">User Menu -</a> <a href="pages_login(alt).blade.php">Logout</a>
                </div>
        ...
        <ul class="nav sidebar-menu">
          ...
          <li>
            <a class="accordion-toggle" href="dashboard.blade.php#">
          ...
          <li>
            ...
            <ul class="nav sub-nav">
              ...
              <li>
              <a href="{{route('ecommerce_products')}}">
                  <span class="glyphicon glyphicon-tags"></span> PUTANGINA </a>
              </li>
              <li>
              <a href="{{route('ecommerce_orders')}}">
                  <span class="fa fa-money"></span> Orders </a>
              </li>
              <li>
              <a href="{{urouterl('ecommerce_customers')}}">
                  <span class="fa fa-users"></span> Customers </a>
              </li>
              <li>
              <a href="{{route('ecommerce_storesettings')}}">
            ...
            <ul class="nav sub-nav">
              <li>
                ...
                <ul class="nav sub-nav">
                  ...
                  <li>
                    <a href="pages_forgotpw(alt).blade.php" target="_blank"> Forgotten Password Alt
                      <span class="label label-xs bg-primary">New</span>
                    </a>
                  </li>
                  <li>
          ...
          <li class="sidebar-proj">
            <a href="dashboard.blade.php#projectThree">
          ...
          <li class="sidebar-stat">
            <a href="dashboard.blade.php#projectOne" class="fs11">
      ...
      <div id="topbar-dropmenu">
        <div class="topbar-menu row">
          <div class="col-xs-4 col-sm-2">
            <a href="dashboard.blade.php#" class="metro-tile">
              <span class="glyphicon glyphicon-inbox"></span>
      ...
      <header id="topbar">
        <div class="topbar-left">
          <ol class="breadcrumb">
            ...
            <li class="crumb-link">
              <a href="dashboard.blade.php">Home</a>
            </li>
        ...
        <div class="topbar-right">
          ...
          <div class="ml15 ib va-m" id="toggle_sidemenu_r">
            <a href="dashboard.blade.php#" class="pl5">
              ...
              <div class="panel" id="p11">
                ...
                <div class="panel-menu pn bg-white">
                  <ul class="nav nav-justified text-center fw600 chart-legend" data-chart-id="#high-column3">
                    <li>
                      <a href="dashboard.blade.php#" class="legend-item" data-chart-id="0"> Tech </a>
                    </li>
                    <li class="br-l">
                      <a href="dashboard.blade.php#" class="legend-item" data-chart-id="1"> Support </a>
                    </li>
                    <li class="br-l">
                      <a href="dashboard.blade.php#" class="legend-item" data-chart-id="2"> Service </a>
                    </li>
                    <li class="br-l">
                      <a href="dashboard.blade.php#" class="legend-item" data-chart-id="3"> Another </a>
                    </li>
                  </ul>
                </div>
      ...
      <footer id="content-footer">
        <div class="row">
          ...
          <div class="col-md-6 text-right">
            ...
            <a href="dashboard.blade.php#content" class="footer-return-top">
      ...
      <div class="sidebar-right-content nano-content">
        ...
        <div class="tab-block sidebar-block br-n">
          <ul class="nav nav-tabs tabs-border nav-justified hidden">
            <li class="active">
              <a href="dashboard.blade.php#sidebar-right-tab1" data-toggle="tab">Tab 1</a>
            </li>
            <li>
              <a href="dashboard.blade.php#sidebar-right-tab2" data-toggle="tab">Tab 2</a>
            </li>
            <li>
              <a href="dashboard.blade.php#sidebar-right-tab3" data-toggle="tab">Tab 3</a>
            </li>
          </ul>
          <div class="tab-content br-n">
            <div id="sidebar-right-tab1" class="tab-pane active">
              ...
              <div class="media">
                ...
                <a class="media-right pl30" href="dashboard.blade.php#">
